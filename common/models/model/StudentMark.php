...
class StudentMark extends ActiveRecord
{
    ...
    {
        return [
            [['student_id', 'subject_id', 'edu_semestr_id', 'edu_semestr_subject_id', 'created_at', 'updated_at'], 'required'],
            [['student_id', 'subject_id', 'edu_semestr_id', 'edu_semestr_subject_id', 'course_id', 'semestr_id', 'edu_year_id', 'faculty_id', 'edu_plan_id', 'edu_lang_id', 'mark', 'attempt', 'status', 'is_deleted', 'created_at', 'updated_at', 'created_by', 'updated_by', 'order'], 'integer'],
            [['exam_control_student_ball', 'exam_control_student_ball2', 'exam_student_ball', 'ball'], 'number'],
            [['description'], 'string'],
            [['data'], 'safe'],
            ['attempt', 'default', 'value' => 1],
            [['alphabet'], 'string', 'max' => 10],
