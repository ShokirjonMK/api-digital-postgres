    ...
    public static function createItem($model, $post)
    {
        ...
        if (isset($post['time_option_id'])) {
            ...
            if (TimeTable::find()->where([
                ...
                $model->lecture = $edu_semestr_subject_category_times->{1};
            } else {
                $model->lecture = 0;
            }
            ...
            if (TimeTable::find()->where([
                ...
                $model->seminar = $edu_semestr_subject_category_times->{2};
            } else {
                $model->seminar = 0;
            }
            ...
            if (TimeTable::find()->where([
                ...
                $model->practical = $edu_semestr_subject_category_times->{3};
            } else {
                $model->practical = 0;
            }
            ...
            if (TimeTable::find()->where([
                ...
                $model->labarothoria = $edu_semestr_subject_category_times->{5};
            } else {
        ...
        $model->faculty_ids = array_values(
            array_unique(
                TimeTable::find()
                    ->where([
                        'teacher_user_id' => $model->user_id,
        ...
        $model->kazus_input = Question::find()->where([
            'subject_id' => $model->subject_id,
            'created_by' => $model->user_id,
            'is_deleted' => 0
        ])->andWhere(['>', 'created_at', 1693508400])->count();
