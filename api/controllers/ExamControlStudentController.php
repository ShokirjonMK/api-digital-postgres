...
class ExamControlStudentController extends ApiActiveController
{
    ...
    public function actionIndex($lang)
    {
        ...
        if (null !==  Yii::$app->request->get('noChek')) {
            $query->andWhere([
                'or',
                ['and', ['not' => [$this->table_name . 'appeal' => null]], [$this->table_name . 'appeal_status' => null]],
                ['and', ['not' => [$this->table_name . 'appeal2' => null]], [$this->table_name . 'appeal2_status' => null]],
            ]);
        ...
        // Check if the 'appeal' parameter is present in the GET request
        if (null !== Yii::$app->request->get('appeal')) {
            // Use 'andWhere' to add a condition to the existing query
            // The condition checks for equality with 'appeal' or 'appeal2'
